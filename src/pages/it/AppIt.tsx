...
const AppIt = () => (
  <>
    ...
    <ContentPageLayout lang="it" title="AKOKY App 2026 | Applicazione Libertina Premium" description="Scarica l'app AKOKY." canonical="https://akoky.com/it/app" heroTitle="L'App Libertina Più Completa d'Europa" heroSubtitle="Geolocalizzazione, chat WhatsApp-like, notifiche eventi e multi-profilo. Tutto sul tuo smartphone." <ContentPageLayout lang="it" title="AKOKY App 2026 | Applicazione Libertina Premium" description="Scarica l'app AKOKY." canonical="https://akoky.com/it/app" heroTitle="L'App Libertina Più Completa d'Europa" heroSubtitle="Geolocalizzazione, chat WhatsApp-like, notifiche eventi e multi-profilo. Tutto sul tuo smartphone." heroImage="/images/es-app-cover.webp" breadcrumb={[{ label: "App AKOKY" }]} faq={FAQ}> breadcrumb={[{ label: "App AKOKY" }]} faq={FAQ}>
