...
const LessicoLibertino = () => {
  ...
  return (
    <>
      ...
      <ContentPageLayout lang="it" title="Lessico Libertino 2026 | 200+ Termini — AKOKY" description="Dizionario libertino completo: scambio, mélangisme, candaulismo, triolismo." canonical="https://akoky.com/it/lessico-libertino" heroTitle="Lessico Libertino" heroSubtitle="Il dizionario completo della community libertina: 200+ termini spiegati in modo accessibile." heroImage="/images/lexique-libertine-cover.webp" breadcrumb={[{ label: "Lessico Libertino" }]} faq={FAQ}>
