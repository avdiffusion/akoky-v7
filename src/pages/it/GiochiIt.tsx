...
const GiochiIt = () => (
  <>
    ...
    <ContentPageLayout lang="it" title="Giochi Libertini AKOKY | Animazioni e Attività" description="Giochi libertini per animare le tue serate." canonical="https://akoky.com/it/giochi" heroTitle="Giochi Libertini AKOKY" heroSubtitle="Anima le tue serate con i nostri giochi esclusivi: roulette, dado, verità o sfida e altro ancora." <ContentPageLayout lang="it" title="Giochi Libertini AKOKY | Animazioni e Attività" description="Giochi libertini per animare le tue serate." canonical="https://akoky.com/it/giochi" heroTitle="Giochi Libertini AKOKY" heroSubtitle="Anima le tue serate con i nostri giochi esclusivi: roulette, dado, verità o sfida e altro ancora." heroImage="/images/es-juegos-cover.webp" breadcrumb={[{ label: "Giochi Libertini" }]} faq={FAQ}> breadcrumb={[{ label: "Giochi Libertini" }]} faq={FAQ}>
