...
const FAQ = [
  ...
  { question: "Puis-je utiliser mon parrainage pour les concours ?", answer: "Certains concours incluent des bonus liés au programme de parrainage Akoky : participations multiples, points bonus, accès prioritaire. Consultez le règlement de chaque concours." },
  ...
  { question: "Comment sont désignés les gagnants ?", answer: "Selon les modalités de chaque concours : tirage au sort, performance (premier à accomplir une tâche), vote communautaire, ou jury Akoky." },
  ...
  { question: "Mes données personnelles sont-elles protégées ?", answer: "Oui. Akoky respecte strictement le RGPD et ne partage jamais vos données avec des tiers." },
];
...
const Concours = () => (
  <>
    ...
    <ContentPageLayout
      lang="fr"
      title="Concours AKOKY – Gagnez des Expériences Libertines Exclusives"
      description="Participez gratuitement aux concours Akoky et tentez de gagner des séjours dans les meilleurs clubs libertins d'Europe."
      canonical="https://akoky.com/fr/concours"
        ...
        <div className="container max-w-5xl mx-auto space-y-20">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { icon: "📸", title: "Concours Photo de Couple", date: "fin 2026 – début 2027", lot: "Week-end Les Chandelles Paris", desc: "Partagez votre plus belle photo de couple libertin et gagnez un week-end premium !" },
                { icon: "✍️", title: "Meilleur Témoignage Libertin", date: "2027", lot: "3 abonnements Premium 1 an", desc: "Racontez votre expérience libertine la plus mémorable." },
                { icon: "🌴", title: "Challenge Parrainage Été", date: "Été 2027", lot: "5 séjours clubs libertins Europe", desc: "Les meilleurs ambassadeurs gagnent un WE de rêve !" },
              ].map((c, i) => (
