...
const FAQ = [
  { question: "Qu'est-ce que le statut VIP Akoky ?", answer: "Le statut VIP Akoky est un abonnement site libertin premium qui vous donne accès à l'ensemble des fonctionnalités exclusives de la plateforme : événements privés, lives en direct, albums photos sécurisés, profils multiples certifiés, visibilité renforcée, support prioritaire et réductions partenaires. C'est la garantie d'évoluer dans un club libert" },
  ...
  { question: "L'abonnement libertin premium est-il vraiment rentable ?", answer: "Absolument. Au-delà des fonctionnalités digitales exclusives, votre statut VIP vous donne accès à des réductions dans les clubs libertins partenaires d'Akoky partout en Europe. Pour les membres actifs qui participent régulièrement à des événements, l' abonnement libertin premium se rentabilise rapidement tout en offrant une expérience bien supérieu" },
];
