...
const FAQ = [
  ...
  { question: "Quelle tenue porter dans un sauna libertin ?", answer: "La plupart des saunas libertins fonctionnent avec un système simple : on vous fournit un peignoir et une serviette à l'entrée. Vous pouvez circuler en peignoir, en serviette, en maillot de bain ou complètement nu selon les espaces et votre niveau de confort. Certains établissements imposent la nudité dans les zones hammam/sauna pour des raisons d'hygiène. La règle générale : faites ce qui vous met à l'aise." },
