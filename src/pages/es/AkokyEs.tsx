      ...
      >
        ...
        <section className="py-16 px-4 bg-background">
          <div className="container max-w-4xl mx-auto space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>Nuestro ecosistema único combina una <strong className="text-foreground">red social libertina segura</strong>, un <Link to="/es/clubbing" className="text-primary hover:underline">directorio de 120 clubes verificados</Link> (Francia, Bélgica, España), <Link to="/es/eventos" className="text-primary hover:underline">300 eventos mensuales</Link> organizados por profesionales formados, <Link to="/es/live" className="text-primary hover:underline">20 lives libertinos semanales</Link> y una <Link to="/es/app" className="text-primary hover:underline">aplicación móvil de vanguardia</Link> con geolocalización en tiempo real.</p>
