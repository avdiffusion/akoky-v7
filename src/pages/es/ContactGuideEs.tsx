...
const ContactGuideEs = () => (
  <>
    ...
    <ContentPageLayout lang="es" title="Contacto AKOKY" description="Soporte y asistencia AKOKY." canonical="https://akoky.com/es/contacto-akoky" heroTitle="Contacto" heroSubtitle="¿Una pregunta? Nuestro equipo está a tu disposición" heroImage="/images/es-contacto-cover.webp" breadcrumb={[{ label: "Contacto" }]} faq={FAQ}> lang="es" title="Contacto AKOKY" description="Soporte y asistencia AKOKY." canonical="https://akoky.com/es/contacto-akoky" heroTitle="Contacto" heroSubtitle="¿Una pregunta? Nuestro equipo está a tu disposición" heroImage="/images/es-contacto-cover.webp" breadcrumb={[{ label: "Contacto" }]} faq={FAQ}> breadcrumb={[{ label: "Contacto" }]} faq={FAQ}>
