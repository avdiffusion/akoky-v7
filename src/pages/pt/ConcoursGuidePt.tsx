...
const ConcoursGuidePt = () => (
  <>
    ...
    <ContentPageLayout lang="pt" title="Concurso AKOKY 2026 | Participa e Ganha Prémios Exclusivos" description="Participa nos concursos exclusivos AKOKY." canonical="https://akoky.com/pt/concurso-akoky-2026" heroTitle="Concurso AKOKY 2026" heroSubtitle="Participa e ganha prémios exclusivos reservados à comunidade AKOKY" heroType="cover" heroImage="/images/pt-concurso-cover.webp" breadcrumb={[{ label: "Concurso AKOKY 2026" }]} faq={FAQ}>
